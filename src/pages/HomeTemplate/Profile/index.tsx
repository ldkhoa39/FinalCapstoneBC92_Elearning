...
import SkeletonLoading from "../_Components/SkelentonLoading";
            ...
            >
              <Card>
                <SectionTitle
                  ...
                  description="Thông tin tài khoản học viên chi tiết."
                />
...
const InfoItem = ({
  ...
  return (
    <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-5">
      ...
      <p className="font-semibold break-all">{value || "Chưa cập nhật"}</p>
    </div>
  );
};
...
const EmptyState = () => {
  return (
    <div className="rounded-[32px] border border-dashed border-slate-700 bg-white/[0.02] py-24 px-6 text-center">
      ...
      <h2 className="text-2xl font-bold mb-3">Không tìm thấy khóa học</h2>
